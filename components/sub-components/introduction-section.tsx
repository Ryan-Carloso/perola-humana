    ...
    return (
      <div className="mb-8 max-w-4xl mx-auto">
        <div className="mb-6 text-gray-700 space-y-4">
          ...
          <p>Meditação:  Cure as células doentes</p>
          <AudioPlayer src="/audio/audio.mp3" />
  
          <h3 className="text-xl font-bold mb-2">INTRODUÇÃO À SAÚDE</h3>

          <p>O acesso ao inconsciente exige compreensão e perspicácia. O meu objetivo não é complicar ou revolucionar, mas simplificar permitindo que todos resgatem os conhecimentos esquecidos.
          <br/> O corpo humano, devido às constantes transformações e contradições que nem a medicina consegue explicar totalmente, tem sido estudado há milênios. 
